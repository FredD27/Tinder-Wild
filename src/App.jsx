...
const MenList = [
  {
    ...
    hobbies:
      "J'aime les séries tv, le jetlag, et faire à manger pour ma femme.",
  },
  {
    ...
    hobbies:
      "J'aime les films romantiques, le backgammon, et manger des barres céréales.",
  },
  {
    name: "David MARIE",
    age: "48 ans",
...
function App() {
  ...
  return (
    <div>
      ...
      <ProfilCard profil={MenList[MenIndex]} />
    </div>
  );
}
